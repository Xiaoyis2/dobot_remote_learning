'''
Sample code downloaded from Dobot official website.
This file handles the DLL calls, development should
be based on functions in this file.

@Warning: Windows python 3.8+ updates ctype, hence %PATH% method no longer
works, use os.add_dll_directory("${path_to_working_dlls_directoy}") instead.
'''
